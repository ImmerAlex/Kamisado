...
public class ContainerElement extends StaticElement {
    ...
    public boolean canReachCell(String to) {
        int row = to.charAt(0) - 'A';
        int col = to.charAt(1) - '1';
        return reachableCells[col][row];
    }
    ...
    public void moveElement(GameElement element, int rowDest, int colDest) {
        ...
        int rs = coords[0]; // row source
        int cs = coords[1]; // col source
        int rd = rowDest; // row dest
        int cd = colDest; // col dest
